...
export interface MerchantCardProps {
   ...
   * (e.g. search results that don't carry a primary service), the meta line
   * shows just the location with no leading separator.
   */
      ...
      >
        ...
        <div className="p-4">
          ...
          {priceFromLabel ? (
            ...
            /* No price + no rating (typical search result for a brand-new
               merchant) — show a "New on Autara" eyebrow so the content row
               isn't left visually empty under the name. */
